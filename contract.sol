...
contract GMJToken is KIP17Full, KIP17Mintable, KIP17MetadataMintable, KIP17Burnable, KIP17Pausable {
    ...
    function mintGMJ(string memory uri, uint256 requestedCount) public payable{

        require(msg.value == _mintPrice.mul(requestedCount), "Check your klaytn. it's not enough");
        require(balanceOf(msg.sender) + requestedCount <= _maxSaleAmount, "Throw your greedy");
    ...
    // 초기값 세팅
    function setUp(uint256 newMaxSaleAmount, uint256 newMintPrice) external onlyMinter{
